      ...
      <div className="flex-1 p-3 overflow-y-auto space-y-4">
                ...
                >
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[10px] text-foreground-muted flex items-center gap-1.5">
                      ...
                      <span
                        className={`font-bold ${
                          isPassable ? 'text-accent-green' : 'text-accent-red'
                        }`}
                      >
                        {state}
                      </span>
        ...
        <div className="p-3 bg-surface-raised rounded border border-surface-border space-y-2.5">
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded bg-accent-teal hover:bg-accent-teal/80 text-foreground font-bold flex items-center justify-center gap-1.5"
          >
