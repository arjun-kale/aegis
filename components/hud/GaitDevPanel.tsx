...
export function GaitDevPanel({
  ...
  return (
    <div className="absolute left-4 top-16 bottom-4 w-[380px] max-w-[calc(100vw-32px)] z-30 flex flex-col bg-surface/95 backdrop-blur-md border border-surface-border rounded-lg shadow-2xl overflow-hidden font-mono text-xs select-none">
      {/* Header */}
